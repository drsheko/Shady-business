...
function Category(props) {
    const item = (i, op) =>{return (<Link to='/'>home </Link>)} 
    ...
    const sortOptions = [
        ...
        {label: 'Default', value: 'default'},
            ...
            const products = [
                {"id": "1000","code": "f230fh0g3","name": "Bamboo Watch","description": "Product Description","image": "vape1.avif","price": 65,"category": "Accessories","quantity": 24,"inventoryStatus": "INSTOCK","rating": 5},
                {"id": "1001","code": "nvklal433","name": "Black Watch","description": "Product Description","image": "vape2.avif","price": 72,"category": "Accessories","quantity": 61,"inventoryStatus": "INSTOCK","rating": 4},
                {"id": "1002","code": "zz21cz3c1","name": "Blue Band","description": "Product Description","image": "vape3.avif","price": 79,"category": "Fitness","quantity": 2,"inventoryStatus": "LOWSTOCK","rating": 3},
            ...
            return (
                <div className="grid grid-nogutter">
                    <div className="col-6 flex" style={{textAlign: 'left'}}>
                        ...
                        <Dropdown options={sortOptions} value={sortKey} optionLabel="label" placeholder=" By" onChange={onSortChange}/>
                    </div>
    ...
    return (
        <div>
           <BreadCrumb model={items} home={home} /> 
            <div className='card'>
                <p className=' text-center text-4xl font-medium capitalize my-2'> vape tanks</p>
            </div>
            <div className="dataview-demo">
            <div className="card">
                <DataView value={products} layout={layout} header={header}
                        itemTemplate={itemTemplate} paginator rows={12}
